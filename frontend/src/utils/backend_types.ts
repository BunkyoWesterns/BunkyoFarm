...
export interface paths {
  ...
  "/api/submitters/check": {
    /**
     * New Submitter
     * @description Check submitter code
     */
    post: operations["check_submitter_api_submitters_post"];
  };
...
export interface components {
  schemas: {
    ...
    MessageResponse_SubmitterKargs_: {
      ...
      /** Message */
      message?: string | null;
      response?: { [key: string]: { value:any, type:"int"|"str"|"float"|"bool"|"any" }} | null;
    };
    /**
     * MessageStatusLevel
     * @enum {string}
    ...
    SubmitterDTO: {
       ...
       */
      kargs?: {
        [key: string]: { value:any, type:"int"|"str"|"float"|"bool"|"any" };
      };
      /**
       * Created At
       * Format: date-time
...
export interface operations {
  ...
  check_submitter_api_submitters_post: {
    requestBody: {
      content: {
        "application/json": components["schemas"]["SubmitterCheckForm"];
      };
    };
    responses: {
      /** @description Successful Response */
