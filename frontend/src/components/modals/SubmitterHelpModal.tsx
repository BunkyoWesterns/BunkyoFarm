...
{`class FlagStatus:
    ...
    ok = 'ok'`} />
            ...
            <Accordion.Item value="my-submitter-is-localhost">
                <Accordion.Control icon={<TbArrowLoopRight2 />}>The submitter to reach is at 127.0.0.1</Accordion.Control>
                <Accordion.Panel>
                    <p>Exploitfarm is in a docker container, so 127.0.0.1 is not the same of the host machine.</p>
                    <p><b>In this specific case you should use 'host.docker.internal': this address has been mapped to the real host loopback interface</b></p>
                </Accordion.Panel>
            </Accordion.Item>
